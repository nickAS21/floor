...
public abstract class BaseTuyaMessage implements MessageEvent, Serializable {
    ...
    public void defaultBuild(SourceMessage sourceMessage, JSONObject messageBody) throws JSONException {
        ...
        if (Objects.nonNull(messageBody) && messageBody.size() > 0) {
            ...
            this.bizData = (Map<String, Object>) messageBody.getJSONObject("bizData");
        }
    }
