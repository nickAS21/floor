 ...
 */
public class ConnectThreadFactory implements ThreadFactory {
    ...
    public static ConnectThreadFactory forName(String name) {
        return new ConnectThreadFactory(name);
    }

    private ConnectThreadFactory(String name) {
