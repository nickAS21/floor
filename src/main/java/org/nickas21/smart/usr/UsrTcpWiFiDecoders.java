...
public class UsrTcpWiFiDecoders {
    ...
    private static final int lenSocRemaining = 2;
    ...
    public static String decodeC1Payload(byte[] payloadBytes) {
        try {
            ...
            i += lenCells;
            double socRemaining = (bbCellsAll.getShort(i) & 0xFFFF) / 10.0;
            i += lenSocRemaining;
    ...
    public static String decodeC0BmsInfoPayload(byte[] payloadBytes) {
        try {
            ...
            i += lenSoc;
            int bmsStatus = bb.getShort(i) & 0xFFFF;
            String bmsStatusStr = UsrTcpWifiStatus.fromStatusByeCode(bmsStatus);
            i += lenBmsStatus;
            i += lenBmsStatus1_2;
            i += lenBmsStatus1_2;
            int errorInfoData = bb.getShort(i) & 0xFFFF;
