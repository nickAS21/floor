...
public enum UsrTcpWifiFault {
    ...
    BATTERY_CHARGE_OVER_TEMPERATURE_WARNING(0x1009, UsrTcpWifiFaultCategory.WARNING,
            "Battery charge with over temperature warning"),
    BATTERY_DISCHARGE_OVER_TEMPERATURE_WARNING(0x1010, UsrTcpWifiFaultCategory.WARNING,
            "Battery discharge with over temperature warning"),
    BATTERY_CHARGE_UNDER_TEMPERATURE_WARNING(0x1011, UsrTcpWifiFaultCategory.WARNING,
            "Battery charge with under temperature warning"),
    BATTERY_DISCHARGE_UNDER_TEMPERATURE_WARNING(0x1012, UsrTcpWifiFaultCategory.WARNING,
            "Battery discharge with under temperature warning"),

    // -------- PROTECTION (0x2xxx) --------
    BATTERY_UNDER_VOLTAGE_PROTECT(0x2001, UsrTcpWifiFaultCategory.PROTECTION,
            "Battery under voltage protect"),
    BATTERY_AND_CELL_OVER_DISCHARGE_PROTECT(0x2002, UsrTcpWifiFaultCategory.PROTECTION,
    ...
    BATTERY_OVER_VOLTAGE_AND_CELL_OVER_CHARGE_PROTECT(0x2004, UsrTcpWifiFaultCategory.PROTECTION,
            "Battery over voltage and cell over charge protect"),
    BATTERY_UNDER_TEMPERATURE_PROTECT(0x2005, UsrTcpWifiFaultCategory.PROTECTION,
            "Battery under temperature protect"),
    BATTERY_OVER_TEMPERATURE_PROTECT(0x2006, UsrTcpWifiFaultCategory.PROTECTION,
            "Battery over temperature protect"),
    BATTERY_CHARGE_OVER_CURRENT_PROTECT(0x2007, UsrTcpWifiFaultCategory.PROTECTION,
            "Battery charge over current protect"),
    BATTERY_DISCHARGE_OVER_CURRENT_PROTECT(0x2008, UsrTcpWifiFaultCategory.PROTECTION,
            "Battery discharge over current protect"),
    CELL_OVER_DISCHARGE_PROTECT(0x2009, UsrTcpWifiFaultCategory.PROTECTION,
            "Cell over discharge protect"),
    CELL_OVER_CHARGE_PROTECT(0x2010, UsrTcpWifiFaultCategory.PROTECTION,
            "Cell over charge protect"),
