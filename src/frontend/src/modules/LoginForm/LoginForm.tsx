...
export default function LoginForm() {
  const { setNotification, props, clear, setParams } =
  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "p-4 rounded-md max-w-[414px] w-full dark:text-white",
            classes.boxShadow
          )}
        >
          <hgroup className="flex flex-col items-center mb-4">
            ...
            <p className="text-center text-sm text-gray-700 dark:text-orange-400">
              Secure Login to Manage Your Smart Home & Solar Energy
            </p>
          </hgroup>
          <TextInput
            label="Username"
          ...
          <Button
            ...
            variant="default"
            classNames={{
              root: "mt-6 bg-[#b6ff6b] dark:bg-orange-400 transition hover:bg-[#b1ff62] text-black hover:text-white rounded-full",
            }}
          >
            Log in
          </Button>
